...
mod ffi {
    ...
    unsafe extern "C++" {
        ...
        fn group(config: &KConfig, group: &QString) -> KConfigGroup;
    ...
    unsafe extern "C++" {
        ...
        type KConfigGroup = crate::kconfiggroup::KConfigGroup;
        type WriteConfigFlags = crate::kconfiggroup::WriteConfigFlags;

        #[rust_name = "group_list"]
        ...
        // #[namespace="rust::kf6::kconfig"]
        // fn group(self: &KConfig, group: &QString) -> KConfigGroup;
        ...
        pub fn name(self: &KConfig) -> QString;
...
impl KConfig {
    ...
    pub fn group(self: &KConfig, name: &QString) -> KConfigGroup {
        ffi::group(self, name)
    }
}
