...
// we receive the default value as string (because that's what we get from the kcfg file), but we need to interpret it as QList<int>. Then we read the entry and return it as a QVariant holding a QList<int>
